...
class NewGameFactory(
    ...
    fun contract01(
        ...
        val candidates = landGenerator.generateCandidates(
            seed = colonySeed,
    ...
    fun settleLandingSite(state: GameState, index: Int): GameState {
        ...
        val candidate = colony.world.landingCandidates.getOrNull(index)
            ?: error("Landing site $index does not exist.")
